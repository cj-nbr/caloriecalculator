...
export default defineConfig({
  ...
  integrations: [sitemap({
    customPages: [
      ...
      'https://caloriecalculatorfree.com/country/spain/calculadora-de-calorias.html',
      'https://caloriecalculatorfree.com/country/spain/calculadora-de-tmb-y-gasto-calorico.html',
      'https://caloriecalculatorfree.com/country/spain/calculadora-de-calorias-para-perder-peso-y-ganar-musculo.html',
      'https://caloriecalculatorfree.com/country/spain/calcular-calorias-de-alimentos-y-macros.html'
    ]
  })],
  prefetch: true,
  build: {
